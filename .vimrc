...
" NOTE: put all customizations here, following plugin management, so that your
" settings are not overwritten by plugins.

" BEGIN VIM SUGGESTED DEFAULT SETTINGS:
...
" END VIM SUGGESTED DEFAULT SETTINGS:
